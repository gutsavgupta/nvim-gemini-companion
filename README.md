...
```lua
{
  ...
  keys = {
    { "<leader>gg", "<cmd>GeminiToggle<cr>", desc = "Toggle AI Agent CLI"},
    { "<leader>gc", "<cmd>GeminiClose<cr>", desc = "Close AI Agent CLI Process"},
    { "<leader>ga", "<cmd>GeminiAccept<cr>", desc = "Accept AI Suggested Changes"},
    { "<leader>gr", "<cmd>GeminiReject<cr>", desc = "Reject AI Suggested Changes"},
